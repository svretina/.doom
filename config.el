...
(after! pdf-tools
  ...
  (add-hook 'pdf-view-mode-hook
            (lambda () (set (make-local-variable 'evil-emacs-state-cursor)
                       (list nil)))))
...
(after! python
  (map! :map python-mode-map "C-c p" #'+python/open-ipython-repl)
...
(after! pdf-tools
  (map! :map pdf-view-mode-map "C-s" #'isearch-forward)
  (map! :map pdf-view-mode-map "C-r" #'isearch-backward)
)
